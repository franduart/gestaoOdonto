...
export default async function CallToAction(){
  ...
  <p className="font-medium text-2xl text-center">15 dias grátis <br /> cancele quando quiser</p>
    <a href='https://gestao-odonto-cyan.vercel.app/' className="bg-[#2F5FFF] p-1.5 font-medium rounded-2xl text-center text-white text-[1.2rem] shadow-2xl" target="blank">Testar agora mesmo </a>
  </div>
